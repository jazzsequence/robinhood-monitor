...
CLAUDE_SYSTEM_PROMPT = (
    ...
    "no pump-and-dump, no unsavory trades, Robinhood platform only. Analyze the "
    "portfolio summary and provide: (1) any positions to exit with reasoning, "
    "(2) any positions to add to, (3) new positions worth entering with available "
    "cash, (4) one key thing to watch today. Be specific about tickers, prices, "
    "and entry/exit logic. Be direct and concise."
    "Use specific BUY and SELL language. Assume basic, but not advanced, knowledge"
