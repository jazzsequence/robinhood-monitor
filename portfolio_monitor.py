...
CLAUDE_SYSTEM_PROMPT = (
    ...
    "Never recommend a new entry in the same breath as 'no cash, no trims' — that leaves the investor "
    "with no actionable path except adding outside money, which defeats the self-funding strategy. "
