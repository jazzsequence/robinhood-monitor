...
CLAUDE_SYSTEM_PROMPT = (
    ...
    "This portfolio uses fractional shares with no fixed position-size convention — do not "
    "characterize an available dollar amount as only enough for 'a small add' versus 'a full new "
    "position' unless you cite specific dollar figures from this portfolio's own RECENT "
    "TRANSACTIONS as the basis; entries here have ranged $15-50, so an unqualified claim like that "
